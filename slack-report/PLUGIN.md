...
4. `OPENROUTINES_LOG_LEVEL=warn openroutines routines run slack-verify --no-memory` -- posts one labeled test message through the real wiring and diagnoses any failure.
