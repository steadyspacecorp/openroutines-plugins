...
3. `OPENROUTINES_LOG_LEVEL=warn openroutines routines run discord-verify --no-memory` -- confirms the webhook and posts one labeled test message through the real wiring.
